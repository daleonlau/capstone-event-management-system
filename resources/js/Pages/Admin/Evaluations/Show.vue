        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div v-if="evaluation.customizations" class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-lg overflow-hidden mb-8">
            ...
            <div class="p-6">
              ...
              <div v-if="evaluation.customizations.topics && evaluation.customizations.topics.length > 0" class="mt-4">
              ...
              <div v-if="evaluation.customizations.has_food !== undefined" class="mt-4">
          ...
          <div v-if="evaluation.status === 'active'" class="bg-green-50 border-l-4 border-green-500 rounded-xl p-4 mb-8">
            <div class="flex items-start gap-3">
              ...
              <div class="text-sm text-green-800">
                ...
                <p class="mt-1 text-xs">Current response count: <span class="font-bold">{{ evaluation.responses_count }}</span></p>
              </div>
            </div>
          </div>
          ...
          <div v-if="evaluation.status === 'closed'" class="bg-blue-50 border-l-4 border-blue-500 rounded-xl p-4 mb-8">
            <div class="flex items-start gap-3">
              ...
              <div class="text-sm text-blue-800">
                ...
                <p class="mt-1 text-xs">Total responses collected: <span class="font-bold">{{ evaluation.responses_count }}</span></p>
              </div>
            </div>
          </div>
