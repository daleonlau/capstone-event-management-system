          ...
          <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div v-for="insight in aiInsightsList" :key="insight.id" 
                   ...
                   class="bg-gray-50 rounded-xl p-4 hover:shadow-md transition cursor-pointer group">
                <div class="flex items-center justify-between mb-3">
                  <div>
                    <h3 class="font-semibold text-gray-800 group-hover:text-purple-600 transition">{{ insight.event_name }}</h3>
                ...
                <p class="text-xs text-gray-400 mt-3">
                  Analyzed: {{ formatAnalyzedDate(insight.analyzed_at) }}
                </p>
              </div>
            </div>
          </div>
