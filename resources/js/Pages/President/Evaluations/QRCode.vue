  ...
  <OrganizationUserLayout>
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-8">
          <Link :href="`/president/evaluations/${evaluation.id}`" 
        ...
        <div class="bg-green-50 border-l-4 border-green-500 rounded-xl p-4 mb-6">
          <div class="flex items-start gap-3">
            ...
            <div class="text-sm text-green-800">
              ...
              <p>Students can scan this QR code to access the evaluation form.</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 mb-6">
          <div class="flex flex-col items-center">
            ...
            <div ref="qrCodeContainer" class="bg-white p-4 rounded-2xl shadow-lg mb-6"></div>
        ...
        <div class="bg-blue-50 rounded-2xl p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="font-medium text-gray-800">Display or Print</p>
                <p class="text-sm text-gray-600">Show this QR code on screen, print it, or share the link.</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="font-medium text-gray-800">Students Scan</p>
                <p class="text-sm text-gray-600">Students scan the QR code to access the evaluation form.</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="font-medium text-gray-800">Collect Feedback</p>
                <p class="text-sm text-gray-600">Students complete and submit the evaluation form.</p>
              </div>
            </div>
          </div>
...
onMounted(async () => {
  if (qrCodeContainer.value) {
    try {
      ...
      await QRCode.toCanvas(canvas, props.qr_data, {
        width: 300,
        margin: 2,
        color: {
          dark: '#000000',
