            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr style="{{ $index % 2 == 0 ? 'background-color: #f9fafb;' : '' }}">
                        ...
                        <td class="text-center" style="font-family: monospace; font-size: 8px;">{{ $student['receipt_number'] ?? '—' }}</td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 40px;">No students found for this event.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
